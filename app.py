...
class Timelog:
    def __init__(self):
        ...
        self.time_label = ttk.Label(self.frame, font=('Ubuntu', 45), background='white')
        ...
        self.saved_time_label = ttk.Label(self.frame, font=('Ubuntu', 18), background='white', foreground='#0ac50a')
